...
```svelte
<script lang="ts">
import { SvelteI18nProvider } from '@pie-qti/i18n';
...
Open `packages/i18n/src/locales/en-US.ts`:
...
- Check existing components for examples: [NavigationBar.svelte](../../assessment-player/src/components/NavigationBar.svelte)
