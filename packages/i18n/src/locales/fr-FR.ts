...
export default {
	...
	interactions: {
		...
		extendedText: {
			...
			enterMathExpression: 'Entrez votre expression mathématique :',
		...
		associate: {
			...
			selectAnotherHotspot: 'Sélectionné : <strong>{label}</strong>. Cliquez sur un autre point pour créer une association.',
	...
	assessment: {
		...
		readingPassages: 'Passages de lecture',
	...
	demo: {
		...
		// Home Page
		homeTitle: 'Lecteur QTI',
		homeSubtitle: 'Un lecteur moderne et indépendant des frameworks pour les éléments d\'évaluation QTI. Fonctionne 100% côté client par défaut, avec des hooks côté serveur optionnels pour une utilisation en production.',
		...
		pageTitle: 'Démo du Lecteur - Lecteur PIE QTI',
	...
	transform: {
		...
		errors: {
			...
			invalidQti: 'Le contenu fourni ne semble pas être du XML QTI valide',
		...
		admin: {
			plugins: {
				...
				subtitle: 'Voir les plugins installés et les points d\'extension disponibles',
				totalPlugins: 'Total des Plugins',
				activePlugins: 'Tous les plugins actifs',
				vendorExtensions: 'Extensions Fournisseur',
				extensionsRegistered: 'Enregistrées',
				storageBackend: 'Backend de Stockage',
				installedPlugins: 'Plugins de Transformation Installés',
				pluginsDescription: 'Ces plugins gèrent les transformations entre différents formats',
				...
				status: 'Statut',
				active: 'Actif',
				vendorExtensionPoints: 'Points d\'Extension Fournisseur',
				extensionsDescription: 'Extensions spécifiques au fournisseur enregistrées dans les plugins',
				noExtensions: 'Aucune extension',
				extensionsActive: '{count} actives',
				availableExtensionPoints: 'Points d\'Extension Disponibles',
				configureExtensions: 'Configurer via config.json ou variables d\'environnement',
				storageBackends: 'Backends de Stockage',
				storageDescription: 'Choisir où stocker les sessions et le contenu transformé',
				transformFormats: 'Formats de Transformation',
				formatsDescription: 'Formats d\'entrée et de sortie pris en charge pour les transformations',
				vendorExtensionTypes: 'Types d\'Extension Fournisseur',
				vendorTypesDescription: 'Personnaliser le comportement de transformation pour des fournisseurs spécifiques',
				uiThemes: 'Thèmes d\'Interface',
				themesDescription: 'Personnaliser l\'apparence de l\'application',
				locales: 'Langues',
				localesDescription: 'Ajouter des traductions pour différentes langues',
				howToConfigure: 'Comment Configurer',
				configureVia: 'Configurer les plugins et extensions via ces méthodes :',
				envVar: 'Variable d\'environnement',
				configFile: 'Fichier de configuration',
				seeExample: 'Voir',
				forStructure: 'pour la structure',
				directCode: 'Code direct',
				registerIn: 'Enregistrer dans',
			},
		},
	},
