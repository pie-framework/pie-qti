	...
	interactions: {
		...
		hotspot: {
			...
			unknownImageDimensions:
				'لا يمكن عرض هذه النقطة الساخنة: أبعاد صورتها غير معروفة، لذا لا يمكن تحديد مواضع المناطق القابلة للتحديد. أضف العرض والارتفاع إلى الصورة، أو حدد أبعاد الملف.',
		},
	...
	transform: {
		...
		detail: {
			...
			browseAssessmentsDescription: {
				zero: 'تصفح ومعاينة {count} اختبار تقييم QTI الموجودة في هذه الجلسة',
				one: 'تصفح ومعاينة اختبار تقييم QTI واحد الموجودة في هذه الجلسة',
				two: 'تصفح ومعاينة اختباري تقييم QTI الموجودة في هذه الجلسة',
				few: 'تصفح ومعاينة {count} اختبارات تقييم QTI الموجودة في هذه الجلسة',
				many: 'تصفح ومعاينة {count} اختبار تقييم QTI الموجودة في هذه الجلسة',
				other: 'تصفح ومعاينة {count} اختبار تقييم QTI الموجودة في هذه الجلسة',
			},
			individualItems: 'العناصر الفردية',
			browseItems: 'تصفح ومعاينة العناصر',
			browseItemsDescription: {
				zero: 'تصفح ومعاينة {count} عنصر QTI الموجودة في هذه الجلسة',
				one: 'تصفح ومعاينة عنصر QTI واحد الموجودة في هذه الجلسة',
				two: 'تصفح ومعاينة عنصري QTI الموجودة في هذه الجلسة',
				few: 'تصفح ومعاينة {count} عناصر QTI الموجودة في هذه الجلسة',
				many: 'تصفح ومعاينة {count} عنصر QTI الموجودة في هذه الجلسة',
				other: 'تصفح ومعاينة {count} عنصر QTI الموجودة في هذه الجلسة',
			},
		},
		...
		transformed: {
			...
			breadcrumb: 'محول',
			title: 'نتائج التحويل',
			// The ICU original inflected neither noun; one/other reproduce it, and
			// the remaining Arabic categories resolve through the .other fallback.
			summary: '{items} تم تحويله في {duration}',
			summaryWithAssessments: '{items} + {assessments} تم تحويله في {duration}',
			summaryItems: {
				one: '{count} عنصر',
				other: '{count} عنصر',
			},
			...
			transformationErrors: {
				zero: '{count} خطأ تحويل',
				one: 'خطأ تحويل واحد',
				two: 'خطأا تحويل',
				few: '{count} أخطاء تحويل',
				many: '{count} خطأ تحويل',
				other: '{count} خطأ تحويل',
			},
		...
		admin: {
			plugins: {
				title: 'إدارة المكونات الإضافية',
				subtitle: 'عرض المكونات الإضافية المثبتة ونقاط التوسع المتاحة',
				totalPlugins: 'إجمالي المكونات الإضافية',
				activePlugins: 'جميع المكونات الإضافية نشطة',
				vendorExtensions: 'توسعات المزود',
				extensionsRegistered: 'مسجلة',
				storageBackend: 'خلفية التخزين',
				installedPlugins: 'المكونات الإضافية للتحويل المثبتة',
				pluginsDescription: 'تتعامل هذه المكونات الإضافية مع التحويلات بين التنسيقات المختلفة',
				pluginName: 'اسم المكون الإضافي',
				format: 'التنسيق',
				priority: 'الأولوية',
				version: 'الإصدار',
				status: 'الحالة',
				active: 'نشط',
				vendorExtensionPoints: 'نقاط توسع المزود',
				extensionsDescription: 'توسعات خاصة بالمزود مسجلة في المكونات الإضافية',
				noExtensions: 'لا توجد توسعات',
				extensionsActive: '{count} نشطة',
				availableExtensionPoints: 'نقاط التوسع المتاحة',
				configureExtensions: 'قم بالتكوين عبر config.json أو متغيرات البيئة',
				storageBackends: 'خلفيات التخزين',
				storageDescription: 'اختر مكان تخزين الجلسات والمحتوى المحول',
				transformFormats: 'تنسيقات التحويل',
				formatsDescription: 'تنسيقات الإدخال والإخراج المدعومة للتحويلات',
				vendorExtensionTypes: 'أنواع توسع المزود',
				vendorTypesDescription: 'تخصيص سلوك التحويل لمزودين محددين',
				uiThemes: 'سمات الواجهة',
				themesDescription: 'تخصيص مظهر التطبيق',
				locales: 'اللغات',
				localesDescription: 'إضافة ترجمات للغات مختلفة',
				howToConfigure: 'كيفية التكوين',
				configureVia: 'قم بتكوين المكونات الإضافية والتوسعات من خلال هذه الطرق:',
				envVar: 'متغير البيئة',
				configFile: 'ملف التكوين',
				seeExample: 'راجع',
				forStructure: 'للبنية',
				directCode: 'كود مباشر',
				registerIn: 'سجل في',
			},
		},
	},
