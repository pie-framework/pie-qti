...
export default {
	...
	interactions: {
		...
		extendedText: {
			...
			enterMathExpression: 'Ingresa tu expresión matemática:',
			latexSource: 'Fuente LaTeX:',
			keyboard: 'Teclado',
			update: 'Actualizar',
			insert: 'Insertar',
		},
		...
		associate: {
			...
			selectAnotherHotspot: 'Seleccionado: <strong>{label}</strong>. Haz clic en otro punto para crear una asociación.',
	...
	demo: {
		...
		// Home Page
		homeTitle: 'Reproductor QTI',
		homeSubtitle: 'Un reproductor moderno e independiente del framework para elementos de evaluación QTI. Funciona 100% del lado del cliente por defecto, con hooks opcionales del lado del servidor para uso en producción.',
		...
		pageTitle: 'Demo del Reproductor - Reproductor PIE QTI',
	...
	transform: {
		...
		errors: {
			...
			invalidQti: 'El contenido proporcionado no parece ser XML QTI válido',
		...
		admin: {
			plugins: {
				...
				subtitle: 'Ver plugins instalados y puntos de extensión disponibles',
				totalPlugins: 'Total de Plugins',
				activePlugins: 'Todos los plugins activos',
				vendorExtensions: 'Extensiones de Proveedor',
				extensionsRegistered: 'Registradas',
				storageBackend: 'Backend de Almacenamiento',
				installedPlugins: 'Plugins de Transformación Instalados',
				pluginsDescription: 'Estos plugins manejan transformaciones entre diferentes formatos',
				...
				status: 'Estado',
				active: 'Activo',
				vendorExtensionPoints: 'Puntos de Extensión de Proveedor',
				extensionsDescription: 'Extensiones específicas del proveedor registradas en plugins',
				noExtensions: 'Sin extensiones',
				extensionsActive: '{count} activas',
				availableExtensionPoints: 'Puntos de Extensión Disponibles',
				configureExtensions: 'Configurar mediante config.json o variables de entorno',
				storageBackends: 'Backends de Almacenamiento',
				storageDescription: 'Elegir dónde almacenar sesiones y contenido transformado',
				transformFormats: 'Formatos de Transformación',
				formatsDescription: 'Formatos de entrada y salida soportados para transformaciones',
				vendorExtensionTypes: 'Tipos de Extensión de Proveedor',
				vendorTypesDescription: 'Personalizar el comportamiento de transformación para proveedores específicos',
				uiThemes: 'Temas de Interfaz',
				themesDescription: 'Personalizar la apariencia de la aplicación',
				locales: 'Idiomas',
				localesDescription: 'Agregar traducciones para diferentes idiomas',
				howToConfigure: 'Cómo Configurar',
				configureVia: 'Configurar plugins y extensiones mediante estos métodos:',
				envVar: 'Variable de entorno',
				configFile: 'Archivo de configuración',
				seeExample: 'Ver',
				forStructure: 'para la estructura',
				directCode: 'Código directo',
				registerIn: 'Registrar en',
			},
		},
	},
} as const;
