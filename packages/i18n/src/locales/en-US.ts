	...
	transform: {
		...
		admin: {
			plugins: {
				...
				subtitle: 'View installed plugins and available extension points',
				totalPlugins: 'Total Plugins',
				activePlugins: 'All plugins active',
				vendorExtensions: 'Vendor Extensions',
				extensionsRegistered: 'Registered',
				storageBackend: 'Storage Backend',
				installedPlugins: 'Installed Transform Plugins',
				pluginsDescription: 'These plugins handle transformations between different formats',
				...
				status: 'Status',
				active: 'Active',
				vendorExtensionPoints: 'Vendor Extension Points',
				extensionsDescription: 'Vendor-specific extensions registered in plugins',
				noExtensions: 'No extensions',
				extensionsActive: '{count} active',
				availableExtensionPoints: 'Available Extension Points',
				configureExtensions: 'Configure these via config.json or environment variables',
				storageBackends: 'Storage Backends',
				storageDescription: 'Choose where to store sessions and transformed content',
				transformFormats: 'Transform Formats',
				formatsDescription: 'Supported input and output formats for transformations',
				vendorExtensionTypes: 'Vendor Extension Types',
				vendorTypesDescription: 'Customize transformation behavior for specific vendors',
				uiThemes: 'UI Themes',
				themesDescription: 'Customize the application appearance',
				locales: 'Locales',
				localesDescription: 'Add translations for different languages',
				howToConfigure: 'How to Configure',
				configureVia: 'Configure plugins and extensions through these methods:',
				envVar: 'Environment variable',
				configFile: 'Config file',
				seeExample: 'See',
				forStructure: 'for structure',
