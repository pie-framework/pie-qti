	...
	interactions: {
		...
		hotspot: {
			...
			unknownImageDimensions:
				'ไม่สามารถแสดงฮอตสปอตนี้ได้: ไม่ทราบขนาดของรูปภาพ จึงไม่สามารถกำหนดตำแหน่งพื้นที่ที่เลือกได้ โปรดเพิ่มความกว้างและความสูงให้กับรูปภาพ หรือระบุขนาดของไฟล์',
		},
