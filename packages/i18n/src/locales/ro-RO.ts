...
export default {
	...
	interactions: {
		...
		extendedText: {
			...
			enterMathExpression: 'Introdu expresia ta matematică:',
			latexSource: 'Sursă LaTeX:',
			keyboard: 'Tastatură',
			update: 'Actualizează',
			insert: 'Inserează',
		},
		...
		associate: {
			...
			selectAnotherHotspot: 'Selectat: <strong>{label}</strong>. Clic pe alt punct pentru a crea o asociere.',
	...
	demo: {
		...
		// Home Page
		homeTitle: 'Player QTI',
		homeSubtitle: 'Un player modern, independent de framework, pentru elemente de evaluare QTI. Funcționează 100% pe partea clientului în mod implicit, cu hook-uri opționale pe partea serverului pentru utilizare în producție.',
		...
		pageTitle: 'Demo Player - Player PIE QTI',
	...
	transform: {
		...
		errors: {
			...
			invalidQti: 'Conținutul furnizat nu pare să fie XML QTI valid',
		...
		admin: {
			plugins: {
				title: 'Gestionare Plugin-uri',
				subtitle: 'Vizualizați plugin-urile instalate și punctele de extensie disponibile',
				totalPlugins: 'Total Plugin-uri',
				activePlugins: 'Toate plugin-urile active',
				vendorExtensions: 'Extensii Furnizor',
				extensionsRegistered: 'Înregistrate',
				storageBackend: 'Backend Stocare',
				installedPlugins: 'Plugin-uri de Transformare Instalate',
				pluginsDescription: 'Aceste plugin-uri gestionează transformările între diferite formate',
				pluginName: 'Nume Plugin',
				format: 'Format',
				priority: 'Prioritate',
				version: 'Versiune',
				status: 'Status',
				active: 'Activ',
				vendorExtensionPoints: 'Puncte de Extensie Furnizor',
				extensionsDescription: 'Extensii specifice furnizorului înregistrate în plugin-uri',
				noExtensions: 'Fără extensii',
				extensionsActive: '{count} active',
				availableExtensionPoints: 'Puncte de Extensie Disponibile',
				configureExtensions: 'Configurați prin config.json sau variabile de mediu',
				storageBackends: 'Backend-uri de Stocare',
				storageDescription: 'Alegeți unde să stocați sesiunile și conținutul transformat',
				transformFormats: 'Formate de Transformare',
				formatsDescription: 'Formate de intrare și ieșire suportate pentru transformări',
				vendorExtensionTypes: 'Tipuri de Extensie Furnizor',
				vendorTypesDescription: 'Personalizați comportamentul de transformare pentru furnizori specifici',
				uiThemes: 'Teme Interfață',
				themesDescription: 'Personalizați aspectul aplicației',
				locales: 'Limbi',
				localesDescription: 'Adăugați traduceri pentru diferite limbi',
				howToConfigure: 'Cum se Configurează',
				configureVia: 'Configurați plugin-urile și extensiile prin aceste metode:',
				envVar: 'Variabilă de mediu',
				configFile: 'Fișier de configurare',
				seeExample: 'Vezi',
				forStructure: 'pentru structură',
				directCode: 'Cod direct',
				registerIn: 'Înregistrează în',
			},
		},
	},
