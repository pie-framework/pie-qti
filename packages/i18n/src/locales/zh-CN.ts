...
export default {
	...
	interactions: {
		...
		associate: {
			...
			selectAnotherHotspot: '已选择:<strong>{label}</strong>。点击另一个热点以创建关联。',
	...
	demo: {
		...
		// Home Page
		homeTitle: 'QTI 播放器',
		homeSubtitle: '一个现代的、与框架无关的 QTI 评估项目播放器。默认情况下 100% 在客户端运行，并提供可选的服务器端钩子用于生产环境。',
	...
	transform: {
		...
		errors: {
			...
			invalidQti: '提供的内容似乎不是有效的 QTI XML',
		...
		admin: {
			plugins: {
				title: '插件管理',
				subtitle: '查看已安装的插件和可用的扩展点',
				totalPlugins: '插件总数',
				activePlugins: '所有插件已激活',
				vendorExtensions: '供应商扩展',
				extensionsRegistered: '已注册',
				storageBackend: '存储后端',
				installedPlugins: '已安装的转换插件',
				pluginsDescription: '这些插件处理不同格式之间的转换',
				pluginName: '插件名称',
				format: '格式',
				priority: '优先级',
				version: '版本',
				status: '状态',
				active: '活动',
				vendorExtensionPoints: '供应商扩展点',
				extensionsDescription: '在插件中注册的供应商特定扩展',
				noExtensions: '无扩展',
				extensionsActive: '{count} 个活动',
				availableExtensionPoints: '可用扩展点',
				configureExtensions: '通过 config.json 或环境变量配置',
				storageBackends: '存储后端',
				storageDescription: '选择存储会话和转换内容的位置',
				transformFormats: '转换格式',
				formatsDescription: '转换支持的输入和输出格式',
				vendorExtensionTypes: '供应商扩展类型',
				vendorTypesDescription: '为特定供应商自定义转换行为',
				uiThemes: 'UI 主题',
				themesDescription: '自定义应用程序外观',
				locales: '语言环境',
				localesDescription: '为不同语言添加翻译',
				howToConfigure: '如何配置',
				configureVia: '通过以下方法配置插件和扩展:',
				envVar: '环境变量',
				configFile: '配置文件',
				seeExample: '查看',
				forStructure: '了解结构',
