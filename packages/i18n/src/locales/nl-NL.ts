...
export default {
	...
	interactions: {
		...
		extendedText: {
			...
			enterMathExpression: 'Voer je wiskundige expressie in:',
			latexSource: 'LaTeX-bron:',
		...
		hotspot: {
			...
			unknownImageDimensions:
				'Deze hotspot kan niet worden weergegeven: de afmetingen van de afbeelding zijn onbekend, waardoor de selecteerbare gebieden niet geplaatst kunnen worden. Voeg breedte en hoogte toe aan de afbeelding of geef de afmetingen van het bestand op.',
		},
		...
		associate: {
			...
			selectAnotherHotspot: 'Geselecteerd: <strong>{label}</strong>. Klik op een ander punt om een associatie te maken.',
	...
	demo: {
		...
		// Home Page
		homeTitle: 'QTI Speler',
		homeSubtitle: 'Een moderne, framework-onafhankelijke speler voor QTI beoordelingsitems. Werkt standaard 100% client-side, met optionele server-side hooks voor productiegebruik.',
		...
		pageTitle: 'Speler Demo - PIE QTI Speler',
	...
	transform: {
		...
		errors: {
			...
			invalidQti: 'De verstrekte inhoud lijkt geen geldige QTI XML te zijn',
		...
		admin: {
			plugins: {
				title: 'Plugin Beheer',
				subtitle: 'Bekijk geïnstalleerde plugins en beschikbare extensiepunten',
				totalPlugins: 'Totaal Plugins',
				activePlugins: 'Alle plugins actief',
				vendorExtensions: 'Leveranciersextensies',
				extensionsRegistered: 'Geregistreerd',
				storageBackend: 'Opslagbackend',
				installedPlugins: 'Geïnstalleerde Transformatie Plugins',
				pluginsDescription: 'Deze plugins verzorgen transformaties tussen verschillende formaten',
				pluginName: 'Plugin Naam',
				format: 'Formaat',
				priority: 'Prioriteit',
				version: 'Versie',
				status: 'Status',
				active: 'Actief',
				vendorExtensionPoints: 'Leveranciersextensiepunten',
				extensionsDescription: 'Leveranciersspecifieke extensies geregistreerd in plugins',
				noExtensions: 'Geen extensies',
				extensionsActive: '{count} actief',
				availableExtensionPoints: 'Beschikbare Extensiepunten',
				configureExtensions: 'Configureer via config.json of omgevingsvariabelen',
				storageBackends: 'Opslagbackends',
				storageDescription: 'Kies waar sessies en getransformeerde inhoud opgeslagen worden',
				transformFormats: 'Transformatieformaten',
				formatsDescription: 'Ondersteunde invoer- en uitvoerformaten voor transformaties',
				vendorExtensionTypes: 'Leveranciersextensietypes',
				vendorTypesDescription: 'Pas transformatiegedrag aan voor specifieke leveranciers',
				uiThemes: 'UI Thema\'s',
				themesDescription: 'Pas het uiterlijk van de applicatie aan',
				locales: 'Talen',
				localesDescription: 'Voeg vertalingen toe voor verschillende talen',
				howToConfigure: 'Hoe te Configureren',
				configureVia: 'Configureer plugins en extensies via deze methoden:',
				envVar: 'Omgevingsvariabele',
				configFile: 'Configuratiebestand',
				seeExample: 'Zie',
				forStructure: 'voor structuur',
				directCode: 'Directe code',
				registerIn: 'Registreer in',
			},
		},
	},
