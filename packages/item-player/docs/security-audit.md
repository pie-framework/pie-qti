# Security Audit Report — `@pie-qti/item-player`

Date: 2026-01-05  
Scope: **core + default components** in `packages/item-player`  
...
- Iframe-isolated deployment guidance: reference doc added at `packages/item-player/docs/iframe-mode.md`, and a host/protocol implementation exists under `packages/item-player/src/iframe/*`.
