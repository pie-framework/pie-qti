...
```typescript
import type { ElementExtractor, ExtractionContext, QTIElement } from '@pie-qti/item-player';
...
```typescript
import { createExtractionRegistry } from '@pie-qti/item-player';
...
```typescript
import type { QTIPlugin } from '@pie-qti/item-player';
...
```typescript
import { createExtractionRegistry, createExtractionContext } from '@pie-qti/item-player';
