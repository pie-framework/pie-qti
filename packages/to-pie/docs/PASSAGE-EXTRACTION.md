...
The to-pie transformer now correctly extracts external passage references from QTI items and populates the PIE `passage` property. This enables proper round-trip transformation when working with external passages generated by pie-to-qti2.
