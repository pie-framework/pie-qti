...
export default {
	...
	transform: {
		...
		detail: {
			...
			cannotConvertMessage: 'تحتوي هذه الحزمة على أنواع تفاعل QTI ليس لها مكافئ في PIE. راجع المشكلات أدناه للحصول على التفاصيل. استخدم مشغل QTI بدلاً من ذلك لمعاينة هذه العناصر.',
