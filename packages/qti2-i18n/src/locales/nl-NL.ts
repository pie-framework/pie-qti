...
export default {
	...
	transform: {
		...
		detail: {
			...
			cannotConvertMessage: 'Dit pakket bevat QTI-interactietypen die geen PIE-equivalent hebben. Zie problemen hieronder voor details. Gebruik in plaats daarvan de QTI-speler om deze items te bekijken.',
