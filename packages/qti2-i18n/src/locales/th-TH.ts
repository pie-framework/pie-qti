...
export default {
	...
	transform: {
		...
		detail: {
			...
			cannotConvertMessage: 'แพ็คเกจนี้มีประเภทการโต้ตอบ QTI ที่ไม่มีเทียบเท่า PIE ดูปัญหาด้านล่างสำหรับรายละเอียด ใช้เครื่องเล่น QTI แทนเพื่อดูตัวอย่างรายการเหล่านี้',
