  ...
  <testPart identifier="part-1" navigationMode="nonlinear" submissionMode="individual">
	...
	onMount(async () => {
		try {
			...
			await customElements.whenDefined('pie-qti-assessment-player');
	...
	<div class="prose max-w-none">
		...
		<ul>
			<li>
				...
				<code>&lt;pie-qti-assessment-player&gt;</code> via <code>customElements</code>.
			</li>
			<li>
	...
	<div class="card bg-base-100 shadow-xl">
		<div class="card-body">
			...
			<div class="bg-base-200 rounded-lg p-4 min-h-[240px]">
				<pie-qti-assessment-player bind:this={el} class="block w-full"></pie-qti-assessment-player>
			</div>
		</div>
	</div>
</div>
