...
- **Cross-platform:** Touch drag must use the `touchDrag` Svelte action (`shared/utils/touchDragHelper.ts`). The stacked single-column layout at ≤640px must make tap-to-pair functional without requiring physical drag.
