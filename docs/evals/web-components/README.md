...
**Files**:
- `packages/player-elements/src/elements/QtiItemPlayerElement.ts`
- `packages/player-elements/src/elements/QtiAssessmentPlayerElement.ts`
...
**File**: `packages/assessment-player/src/core/AssessmentPlayer.ts`
