<script lang="ts">
	...
	import {
		...
		ITEM_PACKAGES_QTI30_ADVANCED,
		TEST_PACKAGES_QTI30_ADVANCED,
...
<div class="container mx-auto max-w-4xl px-4 py-8">
	...
	<!-- QTI 3.0 Advanced divider -->
	<div class="divider my-10"></div>
	<div class="mb-6">
		<h2 class="text-2xl font-bold">QTI 3.0 Advanced</h2>
		<p class="text-base-content/70 text-sm mt-1">
			Official 1EdTech QTI 3.0 Advanced conformance packages. Includes interaction Shared Vocabulary
			behavioral features (qti-input-control-hidden, qti-orientation-*, qti-choices-stacking-N,
			qti-match-tabular, selection messages), I4 Shared Stimulus, and I20 Full Shared Vocabulary CSS.
		</p>
	</div>

	<!-- QTI 3.0 Advanced — item packages -->
	<section class="mb-10" aria-labelledby="qti30adv-item-packages-heading">
		<h3 id="qti30adv-item-packages-heading" class="text-xl font-semibold mb-4 border-b border-base-300 pb-2">
			Item Interaction Packages
		</h3>
		<div class="flex flex-col gap-3">
			{#each ITEM_PACKAGES_QTI30_ADVANCED as pkg (pkg.id)}
				<div class="card bg-base-100 border border-base-300 shadow-sm">
					<div class="card-body py-4 px-5">
						<div class="flex items-start justify-between gap-4">
							<div class="flex-1 min-w-0">
	...
	<!-- QTI 3.0 Advanced — test packages -->
	<section aria-labelledby="qti30adv-test-packages-heading">
		<h3 id="qti30adv-test-packages-heading" class="text-xl font-semibold mb-4 border-b border-base-300 pb-2">
			Assessment Test Packages
		</h3>
		<div class="flex flex-col gap-3">
			{#each TEST_PACKAGES_QTI30_ADVANCED as pkg (pkg.id)}
				<div class="card bg-base-100 border border-base-300 shadow-sm">
					<div class="card-body py-4 px-5">
						<div class="flex items-start justify-between gap-4">
							<div class="flex-1 min-w-0">
